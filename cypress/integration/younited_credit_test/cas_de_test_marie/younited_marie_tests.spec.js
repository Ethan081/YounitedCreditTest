describe('Single credit tests', () =>{
    ...
    it('Professional situation Test', () =>{
        ...
        cy.pageTitle('Younited Credit')
        cy.activityUser(profile.activitySector, profile.profession, profile.contractType, profile.employedFromMouth, profile.employedFromYear, profile.contractType)
